...
Additional visualizations were created from statistical analyses on gender and age to help consolidate an understanding of the bike-sharing market for investors. The gender breakdown for customers vs subscribers was analyzed. From the image below, we can conclude that there are 1.62 male customers for Citi-Bike for every 1 female customer. As for subscribers, there are 2.75 males to every 1 female. It is important to further delve into the reason why there is a lower share of female bike-sharing subscribers and how it can be better marketed to them in Des Moines, Iowa to ensure user satisfaction.

<img src="images/Screen Shot 2022-03-26 at 2.04.33 PM.png" alt="Alt text" title="Optional title" width="500" height="300"/>

The highest concentration of Citi-Bike users were born in 1969, and the second highest concentration of users were born 1989. The pie chart below depicts the year in which users were born, the number of users that make up that portion, and the color of that group depicts their concentration. The darker the blue is in the chart, the more users make up a portion of Citi-Bike users. The trend shows that the least likely group of people to use Citi-Bike are naturally senior citizens, and those born after 2000. 

<p float="left">

<img src="images/Screen Shot 2022-03-26 at 1.54.04 PM.png" alt="Alt text" title="Optional title" width="500" height="300"/>

<img src="images/Screen Shot 2022-03-26 at 1.54.50 PM.png" alt="Alt text" title="Optional title" width="500" height="300">
  
</p>

Several generalizations can be drawn from the statistical analyses from the Citi Bike NYC data that can be applied to prospective business in Des Moines, Iowa. The most transactions for a bike-sharing business would occur towards the latter half of the week, especially weekends. We draw this from "User Trips by Gender by Weekday" graph and we can also presume that bike-sharing users are more likely to use the service on the weekends when they have more leisurely time. All genders used bike-sharing services equally in terms of duration, however there was still more than double the amount of bike-sharing users that were male, than those who identified as female. Thus, to make the bike-sharing service more marketable to female users in Des Moines, we must understand their needs and expectations. Some options to consider for female users are security and safety, as well as accessibility. As for both the younger generation and older generation of bicyclists, location might be an important factor in one's ability to use a bike-sharing service. An example of this would be proximity to universities for those born after 2000. In NYC, we see 4 times the amount of subscribers to customers, a successful figure. A subscription incentive can be applied to Des Moines if the frequency of rides is high enough for users to find it more economical. For investors in Des Moines, Iowa coupled with these Citi-Bike data visualizatons, we hope a thorough understanding is provided on the potential for a bike-sharing business to be introduced to the area.
